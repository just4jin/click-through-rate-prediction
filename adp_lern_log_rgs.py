'''
Implementation of Adaptive learning rate L1 and L2 regularized logistic regression 
using hash-trick one-hot encoding

Reference:  Google for their online CTR prediction system

Adapted from Sam Hocevar <sam@hocevar.net>
'''
